    ...
    \CvSection{\lblWorkExperiences}{
        \workExperience{\en{R \& D Software Engineer}\tr{Arge Yazılım Mühendisi}}{07/2018 - 08/2020 (2 year 1 months)}{Cantek}{Antalya}
        {
            ...
            \en{
                ...
                \textbf{-} An architectural infrastructure design and development that provides central authentication using Keycloak and OAuth2 protocol
                \textbf{-} Event-driven architectural infrastructure design and development with RabbitMQ
            }
            \tr{
                ...
                \textbf{-} Keycloak ile OAuth2 protokolünü kullanarak merkezi authentication sağlayan bir mimari alt-yapı tasarımı ve geliştirmesi  \\
